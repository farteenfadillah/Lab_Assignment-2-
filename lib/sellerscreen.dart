...
import 'package:homestay_raya_ass2/detailscreen.dart';
import 'package:homestay_raya_ass2/loginscreen.dart';
import 'package:homestay_raya_ass2/newproductscreen.dart';
import 'package:homestay_raya_ass2/user.dart';
import 'package:homestay_raya_ass2/views/config.dart';
...
//check permission,get location,get address return false if any problem.
  ...
  Future<void> _showDetails(int index) async {
    Product product = Product.(json) {}(productList[index].toJson());
